...
st.header("Amazon Stock Price Analysis")
...
tickerDf = tickerData.history(period='1d', start='2010-5-31', end='2023-01-16')
...
""")
st.caption("Graph start=2010-5-31, end=2023-01-16")
